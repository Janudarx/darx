...
return ''.$jam.''.$jam.'3:) CHAMPIONS BOT T3AM 3:) '.$name.' 3:)
BOT SITE - THEBOTFATHERS.TK B|

B| Owner B| JAN MUHAMMAD B| UMAR JALIL B| NAEEM TARIQ B| GULL HASSAN B| 
B| FAWAD BAIG B| JAN ALI B| SHEZZY SHYKH B| MUSAB KHAN B| 
B| JUNAID JAHANGIR B| QASIM RAJPUT B| SARMAD TASEER B| MRSQ HAMZA B|
'.$hr;
}
...
CURLOPT_USERAGENT => 'DESCRIPTION by huzaifa.heck.in',
));
$ch=curl_exec($cx);
curl_close($cx);
return ($ch);
